...
const gscVoiceSurvivors: { slug: string; label: string }[] = [
  ...
  { slug: 'can-claude-write-a-quote-estimate', label: 'Claude quote estimate guide' },
  { slug: 'can-chatgpt-generate-invoices-tradie-guide', label: 'ChatGPT invoice guide' },
  { slug: 'send-quote-on-site-30-seconds-handyman', label: 'Send quote on site handyman' },
  { slug: 'chatgpt-got-my-handyman-estimates-wrong', label: 'ChatGPT got estimates wrong founder' },
  { slug: 'invoice-simple-review-for-tradies', label: 'Invoice Simple honest review' },
  { slug: 'invoice2go-review-for-tradies', label: 'Invoice2go honest review' },
  { slug: 'invoice-home-review-for-tradies', label: 'Invoice Home honest review' },
  { slug: 'quotemate-review-for-tradies', label: 'QuoteMate honest review' },
  { slug: 'joist-review-for-tradies', label: 'Joist honest review' },
  { slug: 'wave-invoicing-review-for-tradies', label: 'Wave invoicing honest review' },
