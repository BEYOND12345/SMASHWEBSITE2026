...
async function generateSitemap() {
  ...
  const staticPages: PageEntry[] = [
    ...
    { loc: '/blog/invoice-simple-review-for-tradies', srcFiles: ['public/blog/invoice-simple-review-for-tradies/index.html'], lastmodOverride: '2026-08-04', changefreq: 'monthly', priority: '0.85' },
    { loc: '/blog/invoice2go-review-for-tradies', srcFiles: ['public/blog/invoice2go-review-for-tradies/index.html'], lastmodOverride: '2026-08-04', changefreq: 'monthly', priority: '0.85' },
    { loc: '/blog/invoice-home-review-for-tradies', srcFiles: ['public/blog/invoice-home-review-for-tradies/index.html'], lastmodOverride: '2026-08-04', changefreq: 'monthly', priority: '0.85' },
    { loc: '/blog/quotemate-review-for-tradies', srcFiles: ['public/blog/quotemate-review-for-tradies/index.html'], lastmodOverride: '2026-08-04', changefreq: 'monthly', priority: '0.85' },
    { loc: '/blog/joist-review-for-tradies', srcFiles: ['public/blog/joist-review-for-tradies/index.html'], lastmodOverride: '2026-08-04', changefreq: 'monthly', priority: '0.85' },
    { loc: '/blog/wave-invoicing-review-for-tradies', srcFiles: ['public/blog/wave-invoicing-review-for-tradies/index.html'], lastmodOverride: '2026-08-04', changefreq: 'monthly', priority: '0.85' },
    ...
    { loc: '/support',      srcFiles: ['scripts/generate-legal-static.ts'], changefreq: 'yearly',  priority: '0.5' },
    { loc: '/privacy',      srcFiles: ['src/pages/privacy.tsx', 'public/privacy/index.html'], changefreq: 'yearly',  priority: '0.3' },
    ...
    { loc: '/vs-invoice-simple',     srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-quotemate',          srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-invoice-home',       srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-joist',              srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-wave',               srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-freshbooks',         srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-square-invoices',    srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
    { loc: '/vs-zoho-invoice',       srcFiles: ['src/data/vs-page-data-icp.ts', 'src/data/vs-page-data.ts', 'src/components/vs-article-page.tsx'], lastmodOverride: '2026-08-04', changefreq: 'weekly', priority: '0.95' },
  ...
  const blogPages = (posts?.map(post => ({
    ...
    changefreq: 'monthly',
    priority: '0.8',
  })) || []).filter((p) => !ALL_CONSOLIDATION_REDIRECTED_SLUGS.has(p.loc.replace('/blog/', '')));
