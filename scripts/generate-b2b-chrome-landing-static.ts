...
<head>
  ...
  <script type="application/ld+json">${renderJsonLd({ '@context': 'https://schema.org', '@type': 'VideoObject', name: c.demoVideo.title, description: c.demoVideo.description, thumbnailUrl: `https://i.ytimg.com/vi/${c.demoVideo.id}/maxresdefault.jpg`, uploadDate: c.demoVideo.uploadDate, embedUrl: `https://www.youtube.com/embed/${c.demoVideo.id}`, contentUrl: `https://www.youtube.com/watch?v=${c.demoVideo.id}` })}</script>
  <script type="application/ld+json">${renderJsonLd({ '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'SMASH Invoices for Gmail — B2B AR', applicationCategory: 'BusinessApplication', operatingSystem: 'Chrome', offers: { '@type': 'Offer', price: '0', priceCurrency: 'AUD' }, url: 'https://smashinvoices.com/chrome-extension', downloadUrl: CHROME })}</script>
</head>
<body>
  ...
  <main>
    ...
    <section id="workflow-demo"><h2 style="font-size:24px;">90-second workflow demo</h2>
  ...
  <footer style="text-align:center;padding:32px;color:#64748b;font-size:14px;"><a href="/">Home</a> · <a href="/chrome-extension">Chrome Extension</a> · <a href="/b2b-gmail-quoting">B2B Gmail Quoting</a></footer>
</body>
</html>`;
