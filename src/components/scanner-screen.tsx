  ...
  return (
    <div className="h-full flex flex-col justify-center px-8 bg-white text-[#0F172A]">
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <button className="text-[11px] font-black text-slate-300 uppercase tracking-[0.15em]">
          Skip for now
        </button>

        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center leading-relaxed max-w-[260px]">
