...
const sections: Section[] = [
  ...
  {
    heading: 'Comparisons',
    intro: 'Where SMASH wins on speed — under 60 seconds from job done to invoice sent.',
    links: [
      { to: '/alternatives',            label: 'All alternatives hub', note: 'Compare SMASH to every major invoicing app' },
      { to: '/vs-invoice-simple', label: 'SMASH vs Invoice Simple' },
      { to: '/vs-quotemate',      label: 'SMASH vs QuoteMate' },
      { to: '/vs-joist',          label: 'SMASH vs Joist' },
      { to: '/vs-invoice2go',     label: 'SMASH vs Invoice2go' },
      { to: '/vs-invoice-home',   label: 'SMASH vs Invoice Home' },
      { to: '/vs-wave',           label: 'SMASH vs Wave' },
      { to: '/vs-freshbooks',     label: 'SMASH vs FreshBooks' },
      { to: '/vs-square-invoices', label: 'SMASH vs Square Invoices' },
      { to: '/vs-zoho-invoice',   label: 'SMASH vs Zoho Invoice' },
      { to: '/vs-xero',           label: 'SMASH vs Xero' },
      { to: '/vs-myob',           label: 'SMASH vs MYOB' },
      { to: '/vs-servicem8',      label: 'SMASH vs ServiceM8' },
      { to: '/smash-vs-quickbooks', label: 'SMASH vs QuickBooks' },
      { to: '/smash-vs-fergus',     label: 'SMASH vs Fergus' },
      { to: '/vs-tradify',         label: 'SMASH vs Tradify' },
      { to: '/vs-rounded',         label: 'SMASH vs Rounded' },
    ],
  },
  {
