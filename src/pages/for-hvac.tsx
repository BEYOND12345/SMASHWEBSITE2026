    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for HVAC technicians" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For HVAC Technicians</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            System Running. Invoice Sent. Next Job.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            HVAC jobs have labour, refrigerant, parts, and call-out fees all on one invoice. SMASH builds it from a voice description in under 60 seconds, sent from your phone before you drive away.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Rate types.<br />All handled<br />automatically.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Standard, after-hours, emergency, commercial. Set them once. SMASH applies the right one from your description every time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">4 types</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Rate types handled automatically</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              Emergency At Midnight. Invoice At... When Exactly?
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Cold room compressor failure at a restaurant on a Saturday night. You get there, fix it in three hours, replace the capacitor and contactor. After-hours rate. Then what? Invoice when you get home at 1am? When you wake up Sunday? Payment terms are already slipping.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              HVAC jobs are the hardest to invoice correctly. Refrigerant by the gram, multiple rate cards, parts from a wholesaler. SMASH handles all of it from one voice description before you load the van.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                System Fixed. Invoice Out. While It's Fresh.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "air con service, Daikin 7.1kW, two hours, 500 grams R410A, filter pad, standard rate." SMASH applies your refrigerant rate, labour rate, and parts pricing in a single step. GST calculated. Invoice sent.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Standard, after-hours, emergency, commercial. All your rate types configured once. Applied automatically from your description every time.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the service out loud', body: 'Labour hours, refrigerant quantity, parts replaced, rate type. Say it in plain language on site.' },
                { step: '02', title: 'All components priced correctly', body: 'SMASH applies your refrigerant rate, labour rate, and parts catalog. Every line item separated.' },
                { step: '03', title: 'Invoice sent before you leave', body: "Client receives a professional invoice immediately. Even if it's midnight." },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Refrigerant. Rates. Parts. All on one invoice before you drive away.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For HVAC Technicians</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What HVAC Techs Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I do emergency call-outs most weekends. Before SMASH those invoices would wait until Monday. Now the client gets the invoice before I've left their site. It's changed how fast I get paid.", name: 'Robbie', location: 'HVAC Technician, Sydney' },
              { quote: "The refrigerant pricing was always the thing I'd get wrong. I'd forget the rate or miscalculate the grams. Now I just say the quantity and SMASH works it out. Accurate every time.", name: 'Marcus', location: 'Air Con Tech, Brisbane' },
              { quote: "Residential and commercial at different rates used to trip me up constantly. SMASH applies the right one from the job description. I haven't had to send a revised invoice in months.", name: 'Tanya', location: 'HVAC Business Owner, Melbourne' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'Can I handle emergency call-out rates and standard rates in the same app?',
                a: 'Yes. Set up all your rate types once, standard, after-hours, emergency, commercial. When you describe the job, just mention the rate type and SMASH applies the right one. No manual lookup or calculator needed.'
              },
            ].map(({ q, a }) => (
