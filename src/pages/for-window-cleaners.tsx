...
export function ForWindowCleaners() {
  return (
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for window cleaners" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Window Cleaners</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Your Regular Rounds. Invoiced In Seconds.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Same 20 houses every week. Same prices. Set them once in SMASH and every invoice for every round takes 10 seconds flat.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Your rounds<br />on autopilot.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Set your regular customers once. Every invoice after takes 10 seconds. Stop spending Sundays catching up on admin.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            <div className="py-6 md:py-0 md:pr-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Houses cleaned per week</p>
            </div>
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">10 sec</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Invoice time with SMASH</p>
            </div>
            <div className="py-6 md:py-0 md:pl-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Admin time saved weekly</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-6">The Repetition Problem</p>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              You're Doing The Same Jobs. Rebuilding The Same Invoices.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Mrs Thompson at number 14 gets her windows done every four weeks for $75. You've invoiced her 12 times this year. Twelve times you've typed the same thing. Twelve times you've looked up her number. That's an hour of your life you won't get back, every year, for one customer.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Multiply that by 20 regular customers and you're spending days on admin that should take minutes.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Set Once. Invoice Forever.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Add Mrs Thompson once. Her address, her price, her job type. Every invoice after: say her name, tap send. Ten seconds. Done before you've put the squeegee away.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                New job? Just describe it out loud. SMASH builds the invoice, sends the quote, takes the payment. Your rounds run themselves.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Save your regulars once', body: 'Every customer. Every price. Set it up in minutes, use it forever.' },
                { step: '02', title: 'Say their name. Done.', body: '"Mrs Thompson, standard clean." Invoice built and sent in 10 seconds.' },
                { step: '03', title: 'They pay from the link', body: 'Customer approves and pays from their phone. You get notified immediately.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices. Your rounds on autopilot.
              </h2>
              <p className="font-body text-lg text-brand/60 leading-relaxed mb-6">
                Every invoice is GST-compliant, includes your ABN, and arrives in your customer's inbox as a professional PDF with a payment link attached. No typing. No laptop. Done in 10 seconds.
              </p>
              <a
                href="https://apps.apple.com/app/smash-invoices/id6759475079"
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Window Cleaners</p>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand max-w-2xl">
              Your Rounds On Autopilot.
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Repeat Customer Catalog', body: 'Every regular saved with their price and job type. Monthly rounds take seconds, not minutes.' },
              { title: 'Invoice Read Receipts', body: "See the moment your customer opens the invoice. No more 'did you get it?' phone calls." },
              { title: 'GST-Compliant Every Time', body: 'Professional, tax-ready invoices sent automatically. No manual calculations. No errors.' },
              { title: 'Customer Approval Portal', body: 'Customers approve quotes from their phone in one tap. Your record is locked in instantly.' },
              { title: 'Payment On The Spot', body: "Stripe built in. Customers pay from the invoice link while you're still loading the van." },
              { title: 'Voice Works Outdoors', body: 'Wind, traffic, noise. Deepgram voice recognition handles real-world conditions perfectly.' },
            ].map(({ title, body }) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            ...
            <h2 className="font-display text-3xl lg:text-5xl uppercase tracking-tighter leading-[0.9] text-brand max-w-xl">
              Every Round Invoiced. Every Dollar Captured.
            </h2>
          </div>
          <a
            href="https://apps.apple.com/app/smash-invoices/id6759475079"
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Window Cleaners Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I do the same 18 houses every month. Used to take me a full Sunday afternoon to invoice them all. Now I do it while I'm driving between jobs. My Sunday is mine again.", name: 'Chris', location: 'Window Cleaner, Gold Coast' },
              { quote: "The read receipts alone are worth it. I used to chase people for 2 weeks not knowing if they even got the invoice. Now I can see exactly when they opened it.", name: 'Dave', location: 'Window Cleaner, Brisbane' },
              { quote: "Set up my 20 regulars in about 20 minutes. Every invoice since has taken under 15 seconds. It's genuinely ridiculous how much time I was wasting before.", name: 'Scott', location: 'Window Cleaner, Sydney' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.88] text-white max-w-2xl mb-4">
              Your Rounds. Done Before You Hit The Next Street.
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'What if I have 20 regular customers I clean every month?',
                a: 'Save each one once with their address and price. Every invoice after that takes 10 seconds. Your entire monthly round can be invoiced in under 5 minutes. No re-entering anything.'
              },
            ].map(({ q, a }) => (
