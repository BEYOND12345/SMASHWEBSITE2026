    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for mobile mechanics" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Mobile Mechanics</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Invoice Sent Before They Drive Away.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Hands covered in grease. No problem. Talk for 20 seconds. SMASH builds the invoice, lists the parts, and sends it to their phone on the spot.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Invoice done<br />before they<br />drive away.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Stop losing $250 a week on parts you forgot to charge for. Every job fully invoiced on the spot.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            <div className="py-6 md:py-0 md:pr-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">4-5</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Average jobs per day</p>
            </div>
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">30%</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Parts often forgotten on invoices</p>
            </div>
            <div className="py-6 md:py-0 md:pl-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">25 sec</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-6">The Problem</p>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              You Remember The Job. You Forget To Charge For The Parts.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Oil filter, drain plug washer, half a litre of extra oil from the van stock, none of it makes it onto the invoice because your hands are dirty, the customer is waiting, and typing all that on your phone isn't happening.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Most mobile mechanics lose $50-$100 per job in parts they never charge for. At five jobs a day, that's $250-$500 a week, every week.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Wipe your hands on the rag. Hold the phone up. Say "oil change, oil filter, drain plug washer, 5L Castrol, $180 labour." SMASH builds the full itemised invoice, sends it to their phone. You're done before they've started the engine.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Standard services like oil changes and brake jobs are saved in your catalog. You say the job name, SMASH fills in the parts and labour automatically.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Talk through the job', body: 'Labour, parts, fluids, describe it in plain English. SMASH handles the line items.' },
                { step: '02', title: 'Parts auto-priced', body: 'Your standard services are saved. Common parts pre-loaded. No typing. No forgetting.' },
                { step: '03', title: 'Paid on the spot', body: 'Customer pays from the invoice link before they pull out of the driveway.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Every part. Every hour. On the invoice before they start the car.
              </h2>
              <p className="font-body text-lg text-brand/60 leading-relaxed mb-6">
                Every invoice is GST-compliant, includes your ABN, and arrives in your customer's inbox as a professional PDF with a payment link attached. No typing. No laptop. Done in 25 seconds.
              </p>
              <a
                href="https://apps.apple.com/app/smash-invoices/id6759475079"
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Mobile Mechanics</p>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand max-w-2xl">
              Stop Losing Money On Parts You Forgot To Charge.
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Services Catalog', body: 'Save your standard jobs, oil changes, brake pads, filters. One tap, all parts and labour pre-filled.' },
              { title: 'Parts and Labour Line Items', body: 'Voice-created invoices that itemise every part and every hour. Customers trust detailed invoices. You get paid faster.' },
              { title: 'GST-Compliant Instantly', body: 'Every invoice is tax-ready. Your BAS loves you. Your customers get professional documentation.' },
              { title: 'Customer History', body: "See every job, every invoice, every payment for each customer. 'What did I charge you for last service?' answered in seconds." },
              { title: 'Paid Before They Leave', body: 'Stripe built in. Card payment direct from the invoice link. No chasing. No bank transfers that disappear.' },
              { title: 'Works Anywhere', body: "Mobile reception patchy? SMASH drafts the invoice offline and syncs when you're back in range." },
            ].map(({ title, body }) => (
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Mobile Mechanics Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I was losing money on parts every single job. Too busy to type it all out. Now I just talk through the job while I'm packing up and everything makes it on the invoice.", name: 'Mitch', location: 'Mobile Mechanic, Gold Coast' },
              { quote: "My standard services are saved, oil changes, brakes, the lot. I say the job name and it fills in everything. Takes me literally 20 seconds.", name: 'Steve', location: 'Mobile Mechanic, Brisbane' },
              { quote: "Getting paid on the spot changed my cash flow completely. They pay from the link before they drive off. No more chasing bank transfers for two weeks.", name: 'Luke', location: 'Mobile Mechanic, Sydney' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.88] text-white max-w-2xl mb-4">
              Invoice Done Before They Drive Away.
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'Can I itemise parts separately from labour?',
                a: 'Yes. Describe the job out loud including labour hours and parts used. SMASH separates them into distinct line items automatically. Your customer sees exactly what they are paying for.'
              },
            ].map(({ q, a }) => (
