    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for locksmiths" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Locksmiths</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Door Open. Invoice Sent. Next Call.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Locksmith jobs are fast, 30 minutes, done, onto the next one. SMASH keeps up. Invoice sent before you've driven away, from your phone, in under 60 seconds.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Rate types.<br />Zero<br />confusion.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Standard, after-hours, emergency, commercial. SMASH applies the right rate from your description. No more rate disputes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Rate types handled</p>
            </div>
            <div className="py-6 md:py-0 md:pl-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Jobs you can invoice per hour</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              30-Minute Job. 15-Minute Invoice. The Maths Don't Work.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              You do ten call-outs in a day. Some are 20 minutes. Some are after hours. Some are commercial, some residential, some emergency car lockouts. Four different rate cards, parts on some of them, all to be priced correctly while you're on to the next call.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              The invoice sitting in drafts at the end of a busy Saturday night is the norm for most locksmiths. SMASH changes that. Every job gets invoiced in under 60 seconds, from your phone, before you drive away.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Job Done. Invoice Sent. Money Incoming.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "residential lockout, Darlinghurst, non-destructive entry, one hour, standard rate." SMASH applies your rate, builds the invoice, and sends it before you start the car. Emergency jobs at 2am get invoiced at 2am.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Standard, after-hours, emergency, commercial. All your rate types configured once. Applied automatically from what you describe.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the call-out', body: "Job type, location, rate type, any parts supplied. Say it while you're still at the door." },
                { step: '02', title: 'Right rate applied automatically', body: 'SMASH knows your standard, emergency, and commercial rates. No manual lookup required.' },
                { step: '03', title: 'Client pays before you leave', body: 'Invoice sent immediately with a payment link. Card payment on the spot, no terminal needed.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices. Sent before you start the car.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Locksmiths</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Locksmiths Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I do emergency call-outs at all hours. Before SMASH those invoices would wait until morning and some would get forgotten entirely. Now every job is invoiced before I drive away, even at 3am.", name: 'Shane', location: 'Mobile Locksmith, Sydney' },
              { quote: "The rate card problem was real. Standard, after-hours, commercial all different. I'd mix them up. SMASH applies the right one from my description and I haven't had a rate dispute since.", name: 'Nicole', location: 'Locksmith, Melbourne' },
              { quote: "Getting paid on the spot has changed my business. I send the invoice, the client pays from their phone while I'm packing up, and the money's in my account before I get home.", name: 'Chris', location: 'Locksmith Business Owner, Brisbane' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'Can I get paid on the spot at 2am after an emergency call-out?',
                a: 'Yes. Send the invoice from your phone on site and your client can pay by card immediately from the link. The money moves the same night. No waiting for bank transfers or office hours.'
              },
            ].map(({ q, a }) => (
