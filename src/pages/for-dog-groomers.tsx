    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for dog groomers" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Dog Groomers</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Pup Looking Great. Invoice Sent. Next Door.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Multiple grooms per day, breed-specific pricing, add-ons. SMASH handles the invoicing from your phone between appointments, in under 60 seconds.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Invoice between<br />every<br />groom.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Eight appointments, eight different prices. Stop invoicing everything at night when you're exhausted. Do it between bookings.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Appointments invoiced per day</p>
            </div>
            <div className="py-6 md:py-0 md:pl-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">3+ hrs</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              Eight Appointments. Eight Different Prices. All From Memory.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Golden retriever at the large rate. Cavoodle at the small rate. German shepherd needs a de-shed add-on. One client wants teeth cleaning. Another asks about the flea treatment. Eight grooms, eight different price combinations, all to be recalled and charged correctly at the end of a physical day.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Most mobile groomers invoice everything at night when they're exhausted. SMASH changes that. Invoice between appointments, 60 seconds each, from your phone while the client is getting their dog. Cash flow moves sooner.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Invoice Between Every Groom.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "full groom for the golden retriever, Cronulla, bath, blow dry, trim and nail clip, large dog rate." SMASH applies your large dog pricing, sends the invoice to the client's phone, and you're done before the next booking arrives.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Small, medium, large, extra large. Full groom, express, bath only. All your rates set once. All applied from what you say.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the appointment', body: "Dog size or breed, package, any add-ons. Say it while you're saying goodbye to the client." },
                { step: '02', title: 'Right price applied automatically', body: 'SMASH matches your size tier, package rate, and any extras from your catalog.' },
                { step: '03', title: 'Client gets it immediately', body: 'Invoice sent to their phone before you start the drive to your next appointment.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices. Sent before you reach the next appointment.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Dog Groomers</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.88] text-brand max-w-2xl mb-4">
              Every Groom Invoiced. Every Dollar Captured.
            </h2>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Dog Groomers Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I have 8 appointments most days. I used to do all the invoices in the evening after a long day on my feet. Now I do each one from the van between appointments. My evenings are mine again.", name: 'Amanda', location: 'Mobile Dog Groomer, Sydney' },
              { quote: "The breed pricing thing was something I'd always get slightly wrong on tired days. Now I describe the dog and the service and it's correct every time. No more undercharging Bernese mountain dogs.", name: 'Sophie', location: 'Dog Groomer, Melbourne' },
              { quote: "My clients pay before I've even reached the end of their street. The invoice goes to their phone, they pay by card, and I'm paid by the time I arrive at the next house. It's a completely different way of working.", name: 'Kate', location: 'Mobile Grooming Business, Brisbane' },
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-10">
            {[
              ...
              {
                q: 'What if I have breed-specific pricing and add-ons for the same appointment?',
                a: "Describe the dog's size and breed, the package, and any add-ons in one voice message. SMASH applies your size tier pricing, your package rate, and lists each add-on as a separate line item. All on one invoice."
              },
            ].map(({ q, a }) => (
