    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="/hero_image.png"
            alt="SMASH invoicing app for cleaners"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-display text-[11px] uppercase tracking-[0.2em] text-accent mb-4">For Residential Cleaners</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Stop Spending A Full Day Invoicing.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            You do 5 cleans a day. That's 40 invoices a week. SMASH gets them all done in 30 minutes from the front seat of your car.
          </p>
      ...
      <section className="bg-accent overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10 md:py-14">
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            <span className="block text-[80px] sm:text-[120px] md:text-[160px] font-black leading-[0.85] tracking-tighter text-brand md:self-end">
              30s
            </span>
            <div className="md:pb-6">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                From job to invoice.<br />Sent.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Stop losing hours to end of week admin. Every clean invoiced before you reach the next driveway.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            <div className="py-6 md:py-0 md:pr-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">40+</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Invoices per week for a typical cleaner</p>
            </div>
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">7 hrs</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Admin time saved every week</p>
            </div>
            <div className="py-6 md:py-0 md:pl-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">30 sec</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Per invoice with SMASH</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            <p className="font-display text-[11px] uppercase tracking-[0.2em] text-accent mb-6">The Real Problem</p>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              You're Doing The Work. You're Not Getting Paid For All Of It.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Five cleans a day. At $180 a clean that's $900 a day you should be invoicing. But by the time Thursday night rolls around, you've forgotten two jobs, lost a customer's number, and the invoice you started is still half-finished on your phone.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              That's not laziness. That's the system failing you. You shouldn't need to spend a full evening just sending invoices for work you already finished.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 bg-brand text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-accent mb-6">How SMASH Works</p>
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                You Talk. It Invoices.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Pull up to the next job. Tap record. Say "Mrs Johnson, 3 bedroom house clean, $180." SMASH builds the invoice, applies your GST, and sends it to her phone before you've even gotten out of the car.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Your regulars are already saved. Your prices are already locked in. Every job after setup takes 20 seconds, not 10 minutes.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Talk for 20 seconds', body: 'Describe the job out loud. Customer name, what you did, done.' },
                { step: '02', title: 'Quote built instantly', body: 'SMASH pulls your saved pricing, builds a GST-compliant invoice in seconds.' },
                { step: '03', title: 'Customer gets it immediately', body: 'They receive a professional quote link on their phone. They approve. You get paid.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices. Built while you drive.
              </h2>
              <p className="font-body text-lg text-brand/60 leading-relaxed mb-6">
                Every invoice is GST-compliant, includes your ABN, and arrives in your customer's inbox as a professional PDF with a payment link attached. No typing. No laptop. Done in 30 seconds.
              </p>
              <a
                href="https://apps.apple.com/app/smash-invoices/id6759475079"
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Cleaners</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Regular Customer Catalog', body: 'Save Mrs Johnson once. Every invoice after takes 10 seconds. Your repeat rounds are on autopilot.' },
              { title: 'GST-Compliant Instantly', body: 'Every invoice is tax-ready. No accountant needed. No manual calculation. Just send.' },
              { title: 'Read Receipts', body: "See exactly when your customer opened the invoice. No more 'I never got it.'" },
              { title: 'Customer Approval Portal', body: 'They approve the quote from their phone. You see it confirmed in real time.' },
              { title: 'Stripe Payments Built In', body: 'Get paid directly through the invoice link. Bank transfer, card, all handled.' },
              { title: 'Voice Works Anywhere', body: "In the car, outside a property, hands full of gear. If you can talk, you can invoice." },
            ].map(({ title, body }) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            ...
            <h2 className="font-display text-3xl lg:text-5xl uppercase tracking-tighter leading-[0.9] text-brand max-w-xl">
              Every Clean Invoiced. Every Dollar Captured.
            </h2>
          </div>
          <a
            href="https://apps.apple.com/app/smash-invoices/id6759475079"
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Cleaners Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I was spending Thursday nights for 2 hours just invoicing the week's jobs. Now it takes me 20 minutes. I literally just talk into my phone between cleans and it's done.", name: 'Sarah', location: 'Residential Cleaner, Gold Coast' },
              { quote: "I stopped chasing unpaid invoices the moment I started using SMASH. Customers get the quote on their phone immediately. No more 'I never got it.'", name: 'Mike', location: 'Property Cleaner, Sydney' },
              { quote: "I was probably losing $200-300 a week on jobs I forgot to invoice. Now every single job gets quoted before I leave the driveway. It's put thousands back in my pocket.", name: 'Emma', location: 'Cleaning Business Owner, Brisbane' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'What if my customers are not tech savvy?',
                a: "Customers receive a simple link by email or SMS. They tap to view the invoice, tap to pay. No app needed on their end. If they can read a text message, they can pay your invoice."
              },
            ].map(({ q, a }) => (
