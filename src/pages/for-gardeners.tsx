    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for gardeners" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Gardeners &amp; Lawn Mowing</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Stop Losing Money On Uninvoiced Yard Jobs.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            You mow 6 lawns a day. That's 30 invoices a week. SMASH sends every one before you load the mower back in the ute.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Every lawn<br />invoiced before<br />you leave the street.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Stop losing $300 a week on uninvoiced jobs. Every mow captured before you hit the next driveway.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            <div className="py-6 md:py-0 md:pr-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Average invoices per week</p>
            </div>
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">$500+</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Lost to forgotten jobs</p>
            </div>
            <div className="py-6 md:py-0 md:pl-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">20 sec</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-6">Sound Familiar?</p>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              You're Mowing Six Lawns. You're Invoicing Two.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              A quick mow here, edge and blow there, a bag of mulch from Bunnings on the way. By the time you're done for the day, you can't remember what you charged last time, the cash job from Tuesday is gone, and the mulch markup never made it onto the invoice.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              At $45-$65 a mow, those forgotten jobs add up fast. Most gardeners are losing $300-$600 a week in uninvoiced work. Not from undercharging, from not sending anything at all.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Load the mower back in the ute. Tap record. Say "Johnson's place, front and back mow, edge and blow, $65." SMASH builds the invoice, sends it to their phone, and you drive to the next job. Done before you hit the end of the street.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Regular customers are saved. Materials from Bunnings are pre-priced in the catalog. You're not typing anything, you're talking for 15 seconds.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Talk for 15 seconds', body: 'Customer name, what you did, any materials. Done.' },
                { step: '02', title: 'Materials auto-priced', body: 'Mulch, fertiliser, soil. SMASH has AU prices pre-loaded. No more guessing.' },
                { step: '03', title: 'Invoice sent instantly', body: 'They get it on their phone. They pay. You get notified. Move on.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices. Built before you reach the next lawn.
              </h2>
              <p className="font-body text-lg text-brand/60 leading-relaxed mb-6">
                Every invoice is GST-compliant, includes your ABN, and arrives in your customer's inbox as a professional PDF with a payment link attached. No typing. No laptop. Done in 20 seconds.
              </p>
              <a
                href="https://apps.apple.com/app/smash-invoices/id6759475079"
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Gardeners</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Materials Catalog Built In', body: '2,000+ items pre-priced from Bunnings. Mulch, soil, fertiliser, add them by voice, never undercharge on materials again.' },
              { title: 'Regular Customer Rounds', body: 'Save every yard once. Fortnightly customers are two taps. Your recurring work invoices itself.' },
              { title: 'GST Done Automatically', body: 'Every invoice is GST-compliant. Your accountant will love you. Your customers get professional quotes.' },
              { title: 'Invoice Read Receipts', body: "Know exactly when they've opened it. Stop chasing payment blind, you'll see the moment they view it." },
              { title: 'Stripe Payments Built In', body: 'They pay direct from the invoice link. Card, bank transfer, whatever works for them.' },
              { title: 'Works Without Reception', body: 'Draft the invoice on-site without signal. SMASH syncs it when you hit the road.' },
            ].map(({ title, body }) => (
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Gardeners Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I was doing 30 invoices a week by hand. The mulch and soil never made it on half of them. SMASH has the Bunnings prices built in, I finally stop losing money on materials.", name: 'Jason', location: 'Lawn Mowing, Brisbane' },
              { quote: "My fortnightly customers used to take forever to invoice because I'd forget who owed what. Now they're saved, I tap twice and it's sent. It's embarrassingly simple.", name: 'Troy', location: 'Gardener, Gold Coast' },
              { quote: "I was probably leaving $400 a week on the table. Uninvoiced jobs, forgot to add the mulch, cash jobs I never followed up. SMASH fixed all of it.", name: 'Ben', location: 'Landscaper, Melbourne' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.88] text-white max-w-2xl mb-4">
              Every Lawn Invoiced Before You Leave The Street.
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'What if I do recurring weekly jobs for the same customer?',
                a: 'Save the customer once with their address and weekly rate. Every invoice after takes 10 seconds. Your repeat rounds invoice themselves. No re-entering anything.'
              },
            ].map(({ q, a }) => (
