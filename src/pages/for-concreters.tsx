    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for concreters" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Concreters</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Slab Poured. Invoice Sent. Job Done.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Concreting jobs are big, high value, high complexity, lots of line items. SMASH builds the full invoice from a voice description in under 60 seconds, from your phone, on site.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Invoice the job<br />on the day.<br />Not the weekend.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                High-value jobs need the invoice sent the same day. Your payment clock starts when the concrete cures, not when you find time to type.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Line items handled per job</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              High-Value Jobs Need The Invoice Sent The Same Day.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              You poured the slab. Excavation, base prep, formwork, 4.5 cubic metres of 32MPa, mesh, finishing. A $7,000 job and the invoice is sitting in your head. Every day you wait, your payment terms are burning.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              High-value jobs with many line items are exactly where manual invoicing fails. SMASH lets you describe the whole job out loud and have a professional, itemised invoice sent before the concrete cures.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Invoice The Job On The Day.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "exposed aggregate driveway, 42 square metres, 4.5 cubic metres of 32MPa, mesh reinforced, three days, two crew." SMASH builds every line item from your description with your rates applied.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Concrete by the cubic metre, progress claims, sub-contractor invoices. All handled from voice. All sent from your phone on site.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the scope out loud', body: 'Dimensions, concrete volume, crew days, finishing type. Say it in plain language.' },
                { step: '02', title: 'All line items built automatically', body: 'SMASH prices concrete by the m³, labour by the day, materials from your catalog.' },
                { step: '03', title: 'High-value invoice sent instantly', body: 'Client receives a fully itemised invoice on their phone. Payment clock starts immediately.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices for high-value jobs. Sent before you drive away.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Concreters</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Concreters Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "Big jobs used to mean a complicated invoice I'd put off until the weekend. With SMASH I describe the job before I leave site and the client has a proper invoice that afternoon. They pay faster too.", name: 'Brad', location: 'Concreter, Sydney' },
              { quote: "I do a lot of sub-contract work for builders. They need correct tax invoices with all the line items. SMASH produces exactly what they need, from my voice, in under a minute. No disputes.", name: 'Chris', location: 'Concreting Business Owner, Melbourne' },
              { quote: "The progress claim thing was what got me. I can send 50% upfront and convert to a final invoice. That's proper business invoicing, not just a receipt. My cash flow has improved significantly.", name: 'Nicky', location: 'Licensed Concreter, Brisbane' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'Can I send a progress claim for a large job before it is finished?',
                a: 'Yes. Quote the full scope upfront, then invoice progress claims as you go. SMASH lets you split a job into multiple invoices, 50% on start, balance on completion, or any split you agree with the client.'
              },
            ].map(({ q, a }) => (
