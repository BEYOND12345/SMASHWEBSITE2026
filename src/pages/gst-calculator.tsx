  ...
  return (
    <>
      ...
      <ToolPageHero
        ...
        subline="Free Australian GST calculator. Enter a price, choose add or remove, and get the exact GST amount, ex-GST price, and inc-GST total. No signup needed."
        meta="10% GST · ATO compliant · Free forever"
        headline={
          <>
            <span className="block text-white">Free GST Calculator</span>
            <span className="block text-white">Australia — Add or</span>
            <span className="block text-accent">Remove 10% GST Instantly.</span>
          </>
        }
      />
      ...
      <section className="bg-brand py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
          <RelatedTools
            keywords={['gst', 'tax invoice', 'invoice']}
