    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for rubbish removal" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Rubbish Removal</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Load Cleared. Invoice Sent. Next Pickup.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Rubbish removal is fast-paced. Multiple jobs per day, variable load sizes, tip fees. SMASH invoices every job from your phone in under 60 seconds, between collections.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Invoice after<br />every load.<br />Every time.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Six pickups, six different tip fees. Invoice each one before you start the truck. No catching up at the end of the day.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              ...
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Load types handled automatically</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              Six Pickups. Different Load Sizes. Different Tip Fees. All From Memory.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Job one was a half load, general waste. Job three had soil, which costs more at the tip. Job five was a full commercial site cleanout with builder's rubble at a different rate again. Six jobs, six different price calculations, all sitting in your head while you're on to the next pickup.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Most rubbish removal operators invoice everything at the end of the day when the details are already blurring. SMASH lets you invoice between each job in 60 seconds. Load size priced automatically. Tip fees calculated by waste type. Invoice sent before you start the truck.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Invoice Every Load. After Every Load.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "full truck load clearance, Glebe property, general household waste, half a load of soil, garden waste, tip fees for mixed load, two hours labour." SMASH prices the load, calculates tip fees by waste type, and sends the invoice.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Quarter load, half load, full load. General waste, soil, green waste, construction. All your rates and tip fees configured once. Applied automatically from what you describe.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the job from the truck', body: 'Load size, waste types, labour hours, any extras. Say it before you drive to the tip.' },
                { step: '02', title: 'Load rate and tip fees calculated', body: 'SMASH applies your load pricing and tip fee rates by waste type. GST calculated. All line items separated.' },
                { step: '03', title: 'Client gets it immediately', body: "Invoice sent to their phone before you've left the suburb. Fast service, fast invoice, fast payment." },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Load size. Tip fees. All priced automatically between pickups.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Rubbish Removal</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.88] text-brand max-w-2xl mb-4">
              Every Load Invoiced. Every Dollar Captured.
            </h2>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Rubbish Removal Operators Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I do 6 to 8 pickups a day. The tip fees vary every job depending on what the load is. Before SMASH I was guessing and undercharging constantly. Now I say the waste type and it's priced correctly every time.", name: 'Kevin', location: 'Rubbish Removal, Sydney' },
              { quote: "I started invoicing between each job instead of at the end of the day. The clients get the invoice while they're still at home watching me load the truck. Half of them pay before I've driven away.", name: 'Simone', location: 'Junk Removal Business, Melbourne' },
              { quote: "Commercial site cleanouts are complex invoices. Multiple loads, builder's rubble tip fees, two crew. I used to put those invoices off because they took so long. Now I do them from the site in under two minutes.", name: 'Aaron', location: 'Waste Removal, Brisbane' },
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-10">
            {[
              ...
              {
                q: 'What if different waste types attract different tip fees?',
                a: 'Set each waste type as a separate catalog item with its own tip fee rate. Mention the waste types when you describe the job and SMASH applies the correct tip fee for each. General waste, soil, green waste, and construction rubble all priced accurately on the same invoice.'
              },
            ].map(({ q, a }) => (
