    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for painters" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Painters</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Paint Done. Invoice Sent. Next Job.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Interior, exterior, prep work, primer, topcoat. Describe the job out loud and SMASH builds a complete itemised invoice from your phone before you clean the brushes.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Multi-day job.<br />Invoice done<br />before you pack up.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Your payment clock starts the moment the last coat is dry, not days later when you finally get to the laptop.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">All major</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Major paint brands in catalog</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              Big Job. Late Invoice. Payment Terms Already Slipping.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Three days on a full interior repaint. Labour, prep, primer, topcoat, all the Dulux cans to price and list correctly. But by the time Friday night rolls around, the invoice is half done and your payment clock hasn't started yet.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Paint on your hands, tired legs, and a phone screen that takes ten minutes to produce something professional. SMASH lets you invoice a multi-day job in 60 seconds from your voice before you've cleaned the rollers.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Job Done. Invoice Done. Move On.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "four-day interior repaint, living room and three bedrooms, Dulux Wash and Wear 15 litres, day rate." SMASH prices the labour, the paint, and sends a complete invoice before you've packed the drop sheets.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Your day rate, your hourly rate, your material costs. Set once. Applied automatically every time from your voice description.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the job and materials', body: 'Days worked, prep done, paint brand and volume. Say it in plain language.' },
                { step: '02', title: 'Labour and materials separated', body: 'SMASH builds separate line items for each component. Exactly what clients and builders expect.' },
                { step: '03', title: 'Invoice sent immediately', body: "Client gets a professional invoice on their phone. Your payment clock starts now, not tomorrow." },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Professional invoices. Built before you clean the rollers.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Painters</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Painters Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "Before SMASH I was writing everything on a notepad and typing it up on Sunday. Now I do it from the site on Friday afternoon before I even leave. The client gets it while it's fresh.", name: 'Troy', location: 'Painter and Decorator, Melbourne' },
              { quote: "The paint catalog is what sold me. I mention Dulux Wash and Wear and it's already in there at the right price. I was losing money every week underpricing materials.", name: 'Karen', location: 'Residential Painter, Brisbane' },
              { quote: "Multi-day jobs used to mean a complicated invoice I'd put off. Now I just say the days and what I used and it comes out professional. My clients comment on how good the invoices look.", name: 'Phil', location: 'Painting Business Owner, Gold Coast' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'Can I invoice a multi-day job with paint materials included?',
                a: 'Yes. Describe the full job out loud, days worked, paint brand and litres used, prep and finishing. SMASH separates labour and materials into distinct line items. Clients see exactly what they are paying for.'
              },
            ].map(({ q, a }) => (
