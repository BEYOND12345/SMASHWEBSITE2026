...
const faqs = [
  ...
  {
    q: "Can I just use ChatGPT instead of an AI invoicing app?",
    a: "ChatGPT can draft invoice or quote wording if you paste every rate each time. It cannot hold your catalog, send a tax-ready PDF with payment, or convert an on-site quote to an invoice. SMASH is built for talk → verify → send in about 30 seconds."
  },
  {
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { slug: "can-chatgpt-write-a-quote-estimate", title: "Can ChatGPT Write a Quote?", desc: "Same gap for estimates — ChatGPT drafts wording; SMASH sends an instant quote from your catalog." },
              { slug: "first-quote-wins-instant-quote-on-site", title: "First Quote Wins", desc: "Speed to quote wins the job. Talk, verify, send on site in about 30 seconds." },
            ].map((post) => (
