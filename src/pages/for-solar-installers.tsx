    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for solar installers" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Solar Installers</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            System On. Invoice Sent. Commission Done.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Solar installation invoices are high value and complex. Panels, inverters, labour, STC rebates. SMASH builds the full invoice from a voice description in under 60 seconds.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Line items.<br />All on one<br />invoice.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Panels, inverter, racking, labour, STC rebate. Describe the system once and every component is priced and listed correctly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">6+</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Line items on a typical install invoice</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              A $7,000 Invoice. Six Line Items. Done From Memory On A Phone.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              18 panels at $X each. SolarEdge inverter. Racking. Isolators. Two crew, one day. Minus 32 STCs. It's a complex invoice and it needs to be right because the client is using it for finance approval or a rebate application.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Solar installers regularly delay invoicing because getting it right takes too long on a phone. SMASH lets you describe the system from the roof or the driveway and have a fully itemised, GST-compliant invoice sent in under 60 seconds.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Invoice Commissioned On The Day.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "6.6kW system, 18 LG 370W panels, SolarEdge 5kW inverter with optimisers, two crew one day, deduct 32 STC rebate." SMASH builds the complete invoice with every component priced and the STC deduction shown correctly.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Equipment catalog, crew rates, STC rebate as a negative line item. All configured once. All applied automatically from your description.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the system and install', body: 'Panel count, inverter model, crew days, STC count. Say it on commissioning day.' },
                { step: '02', title: 'Complete invoice built automatically', body: 'Equipment priced from your catalog. STC rebate deducted correctly. GST calculated on the net.' },
                { step: '03', title: 'High-value invoice sent immediately', body: "Client gets a fully itemised tax invoice. Finance-ready format. Sent while you're still on site." },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Complex installs. Finance-ready invoices. Sent from the roof.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Solar Installers</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.88] text-brand max-w-2xl mb-4">
              Every Install Invoiced. Every Dollar Captured.
            </h2>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Solar Installers Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "Solar invoices are the most complex I've ever had to produce. Equipment, labour, STC rebate, all formatted correctly for finance applications. SMASH handles all of it from my voice. I invoice on commissioning day now, not the following week.", name: 'Nathan', location: 'Solar Installer, Sydney' },
              { quote: "I do sub-contract work for three different solar companies. Each has different rates. SMASH stores them separately and I apply the right one from the job description. No errors, no re-invoicing.", name: 'Priya', location: 'Solar Electrician, Melbourne' },
              { quote: "The STC rebate line item was always the thing that slowed me down. Getting the deduction formatted correctly for the client took ages. SMASH shows it as a negative line item, exactly how it needs to appear.", name: 'Dave', location: 'Solar Installation Business, Brisbane' },
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-10">
            {[
              ...
              {
                q: 'Can I handle the STC rebate as a deduction on the invoice?',
                a: 'Yes. Add the STC rebate as a negative line item in your catalog. Mention the STC count in your description and SMASH deducts the correct amount. The final invoice shows the full system price, the rebate deducted, and the net amount your client pays.'
              },
            ].map(({ q, a }) => (
