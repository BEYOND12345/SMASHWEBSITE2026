    ...
    <div className="bg-white">
      ...
      <section className="relative text-white min-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero_image.png" alt="SMASH invoicing app for tilers" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-16 lg:px-24 lg:pb-24 pt-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">For Tilers</p>
          <h1 className="font-display text-[56px] lg:text-[100px] uppercase tracking-tighter leading-[0.88] text-white max-w-5xl mb-6">
            Last Tile Set. Invoice Sent. Next Job.
          </h1>
          <p className="font-body text-xl lg:text-2xl text-white/70 max-w-2xl leading-relaxed mb-8">
            Tiling jobs mean labour by the square metre, adhesive, grout, and sometimes supply of tiles. SMASH invoices it all from a voice description in under 60 seconds.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-8">
            ...
            <div className="pb-2 md:pb-8">
              <p className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.9] text-brand">
                Invoice before<br />the grout<br />sets.
              </p>
              <p className="font-body text-base text-brand/60 font-medium mt-3 max-w-sm leading-[1.4]">
                Floor rate, wall rate, waterproofing, adhesive. All from one voice description. Payment clock starts on the day.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="py-6 md:py-0 md:px-12">
              <p className="font-display text-6xl lg:text-7xl uppercase tracking-tighter text-brand mb-2">Floor/Wall</p>
              <p className="font-display text-[11px] uppercase tracking-[0.2em] text-slate-400">Rate types supported</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-brand mb-8">
              Floor Rate. Wall Rate. Adhesive. Grout. Waterproofing. One Invoice.
            </h2>
            <p className="font-body text-xl text-slate-500 leading-relaxed mb-6">
              Bathroom tiling job. 18 square metres of wall at one rate, 6 square metres of floor at another, waterproofing as a separate line, adhesive and grout on top. All of it to multiply, price, and type out on a phone with adhesive on your hands.
            </p>
            <p className="font-body text-xl text-slate-500 leading-relaxed">
              Tilers have more line items per job than almost any other trade. SMASH handles all of them from one voice description. Say the m², the surfaces, the materials. Invoice done.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-6xl uppercase tracking-tighter leading-[0.9] text-white mb-8">
                Invoice Before The Grout Sets.
              </h2>
              <p className="font-body text-xl text-white/60 leading-relaxed mb-6">
                Say "bathroom tiling, 18 square metres wall, 6 square metres floor, waterproofing wet area, tiles client supplied." SMASH calculates the m² totals, applies your rates, and builds a professional invoice in seconds.
              </p>
              <p className="font-body text-xl text-white/60 leading-relaxed">
                Floor rate, wall rate, outdoor rate. Supply-and-install vs labour only. Set once. Applied automatically from what you say.
              </p>
            </div>
            <div className="space-y-8">
              {[
                { step: '01', title: 'Describe the area and materials', body: 'Square metres, surface type, materials used. Say it in plain language.' },
                { step: '02', title: 'All calculations done automatically', body: "SMASH applies your per-m² rate, prices materials from your catalog, adds waterproofing if mentioned." },
                { step: '03', title: 'Invoice sent from the site', body: 'Client gets it on their phone immediately. Builders get a compliant tax invoice they need.' },
              ].map(({ step, title, body }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-black text-4xl lg:text-5xl uppercase tracking-tighter leading-[0.88] text-brand mb-6">
                Per-m² rates. Materials. Waterproofing. All on one invoice.
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <p className="font-black text-xs uppercase tracking-widest text-accent mb-4">Built For Tilers</p>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <p className="font-black text-xs uppercase tracking-widest text-accent mb-12">What Tilers Say</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I was spending 20 minutes on every bathroom invoice working out floor vs wall rates and the materials. Now I say it out loud and it's done in a minute. The calculation accuracy has stopped arguments with clients.", name: 'Luke', location: 'Tiler, Sydney' },
              { quote: "The waterproofing line item is the thing I always forgot. Now I mention the wet area and it's automatically included. It's a small thing but it's been costing me money for years.", name: 'Gina', location: 'Tiling Contractor, Melbourne' },
              { quote: "I work for three different builders. They all need proper tax invoices with ABN and GST. SMASH produces exactly that from my voice while I'm still packing up. No excuses to delay anymore.", name: 'Marco', location: 'Tiler, Perth' },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl space-y-0 divide-y divide-slate-200">
            {[
              ...
              {
                q: 'Can I invoice floor and wall tiling at different rates on the same job?',
                a: 'Yes. Set your floor rate and wall rate separately. When you describe the job, mention the square metres for each surface type. SMASH calculates each at the right rate and lists them as separate line items.'
              },
            ].map(({ q, a }) => (
