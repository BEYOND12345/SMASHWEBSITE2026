          ...
          {step === 'idle' && (
            <>
              ...
              <p className="text-center font-body text-xs text-brand/35 font-medium">
                Want real invoices with Stripe payment links? <a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer" className="text-accent font-semibold hover:underline">Start Free on iPhone</a>
              </p>
            </>
          )}
  ...
  return (
    <>
      ...
      <ToolPageHero
        ...
        subline="SMASH turns a voice description into a professional, ATO-compliant tax invoice — with a Pay Now button — before you've packed up your tools."
        meta="5 invoices free/month · No credit card · iPhone or Gmail"
        headline={
          <>
            <span className="block text-white">Free Invoice Generator</span>
            <span className="block text-white">Australia — ATO Tax</span>
            <span className="block text-accent">Invoice in 60s.</span>
          </>
        }
      />
      ...
      <section className="bg-brand py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
          <RelatedTools
            keywords={['invoice', 'tax invoice', 'billing']}
