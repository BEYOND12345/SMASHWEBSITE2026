          ...
          {step === 'idle' && (
            <>
              ...
              <p className="text-center font-body text-xs text-brand/35 font-medium">
                Want real invoices with Stripe payment links? <a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer" className="text-accent font-semibold hover:underline">Join Beta</a>
              </p>
            </>
          )}
