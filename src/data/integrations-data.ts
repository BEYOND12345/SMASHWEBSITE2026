...
export const integrations: IntegrationData[] = [
  {
    ...
    seo: {
      title: 'Gmail & iPhone to Xero — SMASH Invoice Sync | SMASH',
      description: 'Send from the field or Gmail. SMASH pushes invoices, contacts, payments and tax codes into Xero — no re-keying. Included on Starter from $15/month.',
      keywords: 'SMASH Xero integration, gmail xero invoice, voice invoice Xero, Xero invoice sync, email to invoice xero',
    },
    ...
    faqs: [
      { q: 'Which SMASH plans include Xero sync?',                                  a: 'Xero sync unlocks on Starter and above. Starter is $15/month on web pricing and includes unlimited invoices, QuickBooks sync and CSV export too.' },
      ...
      { q: 'Is this an official Xero App Store listing?',                           a: 'SMASH connects to Xero from inside the app. If you need marketplace listing details for your accountant, contact support.' },
    ],
    waitlistCopy: 'Connect Xero from SMASH settings and keep invoices, contacts and payments in sync.',
  },
  {
    slug: 'quickbooks',
    ...
    seo: {
      title: 'Gmail & iPhone to QuickBooks — SMASH Invoice Sync | SMASH',
      description: 'Send from the field or Gmail. SMASH pushes invoices, customers, payments and sales tax into QuickBooks Online — no re-keying. Starter from $15/month.',
      keywords: 'SMASH QuickBooks integration, gmail quickbooks invoice, voice invoice QuickBooks, QuickBooks Online sync, email to invoice quickbooks',
    },
    ...
    faqs: [
      { q: 'Which SMASH plans include QuickBooks sync?',                              a: 'QuickBooks Online sync unlocks on Starter and above. Starter is $15/month on web pricing and includes unlimited invoices, Xero sync and CSV export too.' },
      ...
      { q: 'Will the QuickBooks integration be in the QuickBooks App Store?',          a: 'SMASH connects to QuickBooks Online from inside the app. If you need marketplace listing details for your accountant, contact support.' },
    ...
    waitlistCopy: 'Connect QuickBooks from SMASH settings and keep invoices, customers and payments in sync.',
  },
];
