...
export const integrations: IntegrationData[] = [
  {
    ...
    seo: {
      ...
      description: 'Sync SMASH voice invoices straight into Xero. Contacts, invoices, payments, tax codes — kept in sync so your accountant never chases you again. Included on paid SMASH plans from Starter.',
  ...
  },
  {
    ...
    seo: {
      ...
      description: 'Sync SMASH voice invoices straight into QuickBooks Online. Customers, invoices, payments, sales tax — all kept in sync. Included on paid SMASH plans from Starter.',
