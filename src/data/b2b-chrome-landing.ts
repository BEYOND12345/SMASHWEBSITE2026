export const B2B_CHROME_LANDING = {
  ...
  hero: {
    ...
    valueBullets: [
      ...
      { from: 'Spoken Voice', to: 'Estimates' },
    ],
  ...
  deRisking: {
    title: 'Your Customers Don’t Change a Single Habit.',
    body: 'Legacy B2B buyers absolutely refuse to log into specialized “customer portals”. With SMASH, you don’t have to force them to. They keep sending standard emails and PDFs exactly like they always do, while your internal team processes them natively inside Google Chrome.',
  },
  featureMatrix: {
    eyebrow: 'Packaged features',
    title: 'Everything in one Gmail sidebar.',
    items: [
      {
        title: 'Native PDF-to-Quote Parsing',
      ...
      },
      {
        ...
        body: 'Automatically reads incoming job requests in the sidebar and extracts names, addresses, and scopes into structured quotes.',
      },
      {
      ...
      },
      {
        ...
        body: 'Pre-priced trade and component items ready to deploy across AU, NZ, US, CA, and UK out-of-the-box.',
      },
      {
        title: 'Customer Approval Portal',
        body: 'Clients review and sign off on quotes digitally via a secure live link with no login required.',
      },
      {
        title: 'Stripe Card Payments',
        body: 'Accept credit and debit payments directly through the client’s live invoice link.',
      },
      {
        title: 'Live Tracking & Read Receipts',
        body: 'Receive instant visual tracking updates the moment a customer opens your document.',
      },
      {
        title: 'One-Click Ledger Sync',
        body: 'Full background push integration with Xero and QuickBooks Online via clean OAuth 2.0.',
      },
      {
        title: 'Universal CSV Export',
        body: 'Seamlessly download files completely compatible with MYOB, Sage, FreshBooks, Wave, and Zoho.',
      },
      {
        title: 'Professional Branded PDFs',
        body: 'Clean layouts featuring your custom logo, personalized terms and conditions, and automated calculations.',
      },
      {
        title: 'Localized Global Tax Engine',
        body: 'Flawless, automated calculation rules for GST, VAT, and US Sales Tax based on your local business settings.',
      },
    ],
  },
  pricing: {
  ...
  footerCta: {
    headline: 'Your inbox is already your order desk.',
    subheadline:
      'Turn PDF POs, customer emails, and voice notes into priced quotes and invoices — standalone, or synced to Xero and QuickBooks Online.',
    primaryCta: 'Add to Chrome — It’s Free',
    subtext: 'Works standalone. Optional Xero or QuickBooks Online sync via OAuth.',
  },
  faqs: [
    {
      q: 'Do I need Xero or QuickBooks to use SMASH?',
      a: 'No. SMASH works as a fully featured, standalone quoting and invoicing tool. It manages your items, tracks clients, creates PDFs, and processes payments entirely on its own. Xero and QuickBooks sync is an optional power-tool addition available when you want it — not required to get started.',
    },
    {
    ...
    {
      q: 'Is my financial and email data secure?',
      a: 'Absolutely. Your local parameters, catalog files, and tokens are safely isolated within your browser storage sandbox. Xero and QuickBooks connect exclusively via official, bank-grade OAuth 2.0 pipelines. Voice inputs are instantly converted to plain text locally — no audio is ever logged, stored, or shared. Financial data is never shared with third parties.',
    },
  ],
  breadcrumbs: [
