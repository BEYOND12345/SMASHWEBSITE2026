...
export interface ComparisonData {
  ...
  /** Internal links shown as a contextual "Explore SMASH" strip between FAQ and audience sections. */
...
const comparisons: ComparisonData[] = [
  {
    ...
    metaTitle: 'Xero Alternative for Tradies | SMASH vs Xero | Voice Invoicing App',
    metaDescription: 'Looking for a Xero alternative? SMASH sends GST-compliant invoices from your phone in 60 seconds — no accounting degree needed. Free plan. Compare SMASH vs Xero features and pricing.',
    ...
    faq: [
      ...
      {
        q: 'Is Xero good for tradies who invoice on the job?',
        a: 'Xero is excellent for accounting — but it was designed for a desk, not a job site. Tradies who try to invoice via Xero on a phone find the experience slow and fiddly. SMASH is purpose-built for on-site invoicing: voice input, one-tap send, and a free plan to start.',
      },
      {
        q: 'Can Xero do voice invoicing?',
        a: 'No. Xero has no voice input feature. Every invoice in Xero requires typing — filling in line items, descriptions, rates, and GST manually. SMASH turns a 30-second voice note into a complete, GST-compliant invoice automatically.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      { label: 'SMASH pricing', to: '/pricing' },
      { label: 'All features', to: '/features' },
      { label: 'Xero integration', to: '/integrations-xero' },
      { label: 'For plumbers', to: '/for-plumbers' },
      { label: 'For electricians', to: '/for-electricians' },
    ],
  },
  {
    slug: 'smash-vs-myob',
    ...
    metaTitle: 'MYOB Alternative for Tradies | SMASH vs MYOB | Voice Invoicing App',
    metaDescription: 'Looking for a MYOB alternative? SMASH sends professional invoices from your phone in 60 seconds — no setup, no desk required. Free plan available. Compare SMASH vs MYOB for Australian tradies.',
    ...
    faq: [
      ...
      {
        q: 'Is MYOB good for tradies on the job?',
        a: 'MYOB is good for accounting — but it\'s a desk tool. On a job site, using MYOB to create an invoice is slow and frustrating on a phone. SMASH is designed specifically for tradies: voice input, mobile-first, and free to start.',
      },
      {
        q: 'Can MYOB do voice invoicing?',
        a: 'No. MYOB requires manual entry for every invoice — line items, descriptions, tax codes. SMASH removes that entirely: describe the job out loud, and the invoice writes itself in seconds.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
  ...
  },
  {
    ...
    metaTitle: 'ServiceM8 Alternative for Solo Tradies | SMASH vs ServiceM8',
    metaDescription: 'Looking for a ServiceM8 alternative? SMASH is simpler, cheaper, and built for solo tradies who just need fast quotes and invoices — no onboarding calls, no setup fees. Free plan.',
    ...
    faq: [
      ...
      {
        q: 'Is ServiceM8 good for solo tradies?',
        a: 'ServiceM8 is genuinely good — for teams. For a solo tradie, you\'re paying for scheduling boards, dispatch tools, and compliance forms you\'ll never use. SMASH is right-sized for one person: fast invoicing, zero complexity, free to start.',
      },
      {
        q: 'Can ServiceM8 do voice invoicing?',
        a: 'No. ServiceM8 has no voice input. Every invoice requires tapping through job cards and filling in line items. SMASH was built around voice from the ground up — describe the job, done in 60 seconds.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      ...
      { label: 'For plumbers', to: '/for-plumbers' },
      { label: 'For electricians', to: '/for-electricians' },
      { label: 'For handymen', to: '/for-handymen' },
    ],
  },
  {
    ...
    metaTitle: 'QuickBooks Alternative for Tradies | SMASH vs QuickBooks | Voice Invoicing',
    metaDescription: 'Looking for a QuickBooks alternative? SMASH invoices from your phone in 60 seconds — voice-first, mobile-only, free to start. Compare SMASH vs QuickBooks for Australian tradies.',
    ...
    faq: [
      ...
      {
        q: 'Is QuickBooks good for tradies invoicing on site?',
        a: 'QuickBooks is good for accounting — but it\'s designed for a computer, not a van. Tradies using QuickBooks to invoice on-site typically spend 10-15 minutes per invoice navigating menus and typing. SMASH averages 60 seconds using voice. For on-site invoicing, the difference is significant.',
      },
      {
        q: 'Can QuickBooks do voice invoicing?',
        a: 'No. QuickBooks has no voice-to-invoice feature. All line items, descriptions, and amounts must be typed manually. SMASH is the only invoicing app built specifically around voice input for tradies — describe the job and the invoice is written for you.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      { label: 'SMASH pricing', to: '/pricing' },
      { label: 'All features', to: '/features' },
      { label: 'QuickBooks integration', to: '/integrations-quickbooks' },
      { label: 'For HVAC technicians', to: '/for-hvac' },
      { label: 'For painters', to: '/for-painters' },
    ],
  },
  {
    ...
    metaTitle: 'Fergus Alternative for Solo Tradies | SMASH vs Fergus | Voice Invoicing',
    metaDescription: 'Looking for a Fergus alternative? SMASH is faster, cheaper, and built for solo tradies who just need to quote and get paid — not manage a crew. Free plan. No onboarding calls.',
    ...
    faq: [
      ...
      {
        q: 'Is Fergus good for sole traders?',
        a: 'Fergus was built by a plumber and genuinely understands trade workflow — but it\'s designed for businesses with staff, job costing needs, and dispatch requirements. For a sole trader, you\'re paying for and navigating features you\'ll never use. SMASH is the right-sized alternative: quote, invoice, get paid.',
      },
      {
        q: 'Can Fergus do voice invoicing?',
        a: 'No. Fergus has no voice input. Creating a quote or invoice in Fergus requires working through job cards, filling in line items manually, and navigating a feature-heavy interface. SMASH replaces all of that with a 30-second voice note.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      ...
      { label: 'For plumbers', to: '/for-plumbers' },
      { label: 'For electricians', to: '/for-electricians' },
      { label: 'For concreters', to: '/for-concreters' },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaTitle: 'Tradify Alternative for Sole Traders | SMASH vs Tradify | Voice Invoicing',
    metaDescription: 'Looking for a Tradify alternative? SMASH has a real free plan, no per-user fees, and voice-to-invoice in 60 seconds — no setup, no price books, no onboarding call needed.',
    ...
    faq: [
      ...
      {
        q: 'Is Tradify good for sole traders?',
        a: 'Tradify is well-built — but it\'s designed for businesses with staff, scheduling needs, and structured price books. For a sole trader, you pay per user and wade through features you don\'t need. SMASH is flat-rate, free to start, and built for one person to use from a van.',
      },
      {
        q: 'Can Tradify do voice invoicing?',
        a: 'No. Tradify requires manual entry for every quote and invoice — picking items from a price book, filling in timesheets, working through job cards. SMASH replaces that entirely: speak the job description, get a finished invoice. No typing required.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      ...
      { label: 'For painters', to: '/for-painters' },
      { label: 'For handymen', to: '/for-handymen' },
      { label: 'For tilers', to: '/for-tilers' },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaTitle: 'Invoice2go Alternative for Tradies | SMASH vs Invoice2go | Voice Invoicing',
    metaDescription: 'Looking for an Invoice2go alternative? SMASH uses voice — not templates — to build invoices in 30 seconds. Free plan with real GST invoices. Built for Australian tradies.',
    ...
    faq: [
      ...
      {
        q: 'Is Invoice2go good for Australian tradies?',
        a: 'Invoice2go works as a generic mobile invoicing app and does support GST and ABN. But it\'s a template-based tool built for any small business worldwide — not specifically for tradies. SMASH is purpose-built for trades: voice recognition trained on trade language, GST and ABN by default, and a free plan with real invoices.',
      },
      {
        q: 'Can Invoice2go do voice invoicing?',
        a: 'No. Invoice2go is a form-based template app — every invoice requires you to tap through fields and type descriptions manually. SMASH removes the keyboard entirely: describe the job out loud and the invoice is ready to send in seconds.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      ...
      { label: 'For gardeners', to: '/for-gardeners' },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaTitle: 'Joist Alternative for AU/NZ/UK Tradies | SMASH vs Joist | Voice Invoicing',
    metaDescription: 'Looking for a Joist alternative? SMASH is voice-first, AI-priced, and built for AU, NZ and UK tradies from day one — GST, VAT, and local tax handled automatically. Free plan.',
    ...
    faq: [
      ...
      {
        q: 'Is Joist good for Australian and NZ tradies?',
        a: 'Joist works globally but is built around the US market — HomeAdvisor/Angi integrations, USD-first, US contractor workflows. For Australian and NZ tradies who need GST, ABN or NZBN on every invoice, SMASH handles local tax rules natively from the first invoice, not as a configured afterthought.',
      },
      {
        q: 'Can Joist do voice invoicing?',
        a: 'No. Joist is a form-based estimating and invoicing app — you fill in sections, pick line items, and type descriptions. SMASH replaces the entire form with a voice note: describe the job in 30 seconds and the invoice is ready to send.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaTitle: 'Rounded Alternative for Tradies | SMASH vs Rounded | Voice Invoicing App',
    metaDescription: 'Looking for a Rounded alternative? SMASH is voice-first and built for tradies on the job — not freelancers at a desk. Free plan with real GST invoices. No credit card required.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Rounded is excellent for freelancers and consultants who work at a desk. For tradies who need to invoice on site — standing next to a ute with tools in hand — Rounded\'s web-first flow is the wrong fit. SMASH is built for that exact moment: voice input, mobile-first, and free to start.',
      },
      {
        q: 'Can Rounded do voice invoicing?',
        a: 'No. Rounded is a web-first accounting app that requires you to type invoices at a keyboard. SMASH is voice-first: describe the job out loud, and the invoice is complete in under 60 seconds — no desk, no keyboard, no waiting until you get home.',
      },
    ],
    relatedLinks: [
      { label: 'How voice invoicing works', to: '/voice-invoicing' },
      { label: 'SMASH pricing', to: '/pricing' },
      { label: 'GST-compliant invoicing', to: '/gst-compliant-invoicing' },
      { label: 'For mobile mechanics', to: '/for-mobile-mechanics' },
      { label: 'For gardeners', to: '/for-gardeners' },
    ],
  },
];
