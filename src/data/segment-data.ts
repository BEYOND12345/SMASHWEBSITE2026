...
export const segments: SegmentData[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      ...
      keywords: 'cleaning business invoice, invoice for cleaners, cleaning service invoice app, domestic cleaning invoice, commercial cleaning invoice Australia',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Plumbers | Plumbing Invoice App Australia | SMASH',
      ...
      keywords: 'plumbing invoice app, invoice for plumbers, plumber invoice software, plumbing business invoicing, plumber quote app Australia',
    ...
    features: [
      ...
      { title: 'Trade materials database', body: '2,250+ Australian trade materials already priced. Common plumbing supplies — pipe, fittings, valves — are in the system.' },
    ...
    faqs: [
      { q: 'Can SMASH handle plumbing materials pricing?', a: 'Yes. SMASH has 2,250+ Australian trade materials. Common plumbing supplies — copper fittings, PVC pipe, valves — are already priced. Add your supplier-specific rates to your own catalog too.' },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Electricians | Electrical Invoice App Australia | SMASH',
      ...
      keywords: 'electrician invoice app, invoice for electricians, electrical business invoicing, electrician quote app, electrical contractor invoice Australia',
    ...
    faqs: [
      { q: 'Can I add electrical materials and parts to my pricing catalog?', a: 'Yes. SMASH has a database of Australian trade materials including common electrical supplies — cable, conduit, switchboards, light fittings, GPOs. Add your specific supplier pricing too.' },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Handymen | Handyman Invoice App Australia | SMASH',
      ...
      keywords: 'handyman invoice app, invoice for handymen, handyman business invoicing, odd jobs invoice, maintenance invoice app Australia',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Painters | Painter Invoice App Australia | SMASH',
      ...
      keywords: 'painter invoice app, invoice for painters, painting business invoicing, decorator invoice Australia, painting quote app',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      ...
      keywords: 'gardener invoice app, landscaper invoice, garden maintenance invoice Australia, lawn mowing invoice app, landscaping quote software',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Mobile Mechanics | Mechanic Invoice App Australia | SMASH',
      ...
      keywords: 'mobile mechanic invoice app, mechanic invoice Australia, auto repair invoice app, roadside mechanic invoice, mobile mechanic quote software',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for HVAC & Air Con Technicians | SMASH Invoices Australia',
      ...
      keywords: 'HVAC invoice app, air conditioning invoice, air con technician invoicing Australia, HVAC quote software, refrigeration invoice app',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Pest Control Operators | Pest Invoice App Australia | SMASH',
      ...
      keywords: 'pest control invoice app, pest controller invoicing Australia, termite inspection invoice, pest treatment invoice, pest control quote software',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Concreters | Concrete Invoice App Australia | SMASH',
      ...
      keywords: 'concreter invoice app, concrete invoice Australia, concreting business invoicing, driveway invoice, concrete quote software',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Tilers | Tiling Invoice App Australia | SMASH',
      ...
      keywords: 'tiler invoice app, tiling invoice Australia, tile laying invoice, tiler quote software, ceramic tile invoice app',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Locksmiths | Locksmith Invoice App Australia | SMASH',
      ...
      keywords: 'locksmith invoice app, locksmith invoicing Australia, key cutting invoice, lock installation invoice, emergency locksmith invoice',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      ...
      keywords: 'car detailing invoice app, mobile detailer invoice, car wash invoice Australia, detailing business invoicing, auto detailing invoice',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      ...
      keywords: 'dog grooming invoice app, mobile pet groomer invoice, grooming business invoicing Australia, dog wash invoice, pet grooming quote app',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Arborists & Tree Services | Tree Invoice App Australia | SMASH',
      ...
      keywords: 'arborist invoice app, tree service invoice Australia, tree removal invoice, stump grinding invoice, arborist quote software',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Pool Maintenance | Pool Service Invoice App Australia | SMASH',
      ...
      keywords: 'pool service invoice app, pool maintenance invoicing Australia, pool cleaning invoice, pool technician invoice, pool chemical invoice',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Solar Installers | Solar Invoice App Australia | SMASH',
      ...
      keywords: 'solar installer invoice, solar installation invoice Australia, solar panel invoice, solar quote software, CEC installer invoice',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seo: {
      title: 'Invoicing for Rubbish Removal | Junk Removal Invoice App Australia | SMASH',
      ...
      keywords: 'rubbish removal invoice, junk removal invoice Australia, waste removal invoice app, hard rubbish invoice, rubbish collection quote',
