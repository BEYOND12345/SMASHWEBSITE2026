...
export const segments: SegmentData[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    blogPosts: [
      { slug: 'how-to-invoice-as-a-cleaner-australia', title: 'How to Invoice as a Cleaner', desc: 'What cleaners need on an invoice in Australia — business details, ABN, service description, GST and payment terms.' },
      ...
      { slug: 'invoice-without-typing', title: 'Invoice Without Typing', desc: 'The no-keyboard workflow for service workers who do not want admin after the last job.' },
    ],
    faqs: [
